...
# We will create for each section a pdf with the code to 
# used in HOMRNA
# - Required reports:
#    - DEA
#    - Normalization
...
output$reportNorm <- downloadHandler(
  ...
  filename = "report_normalization_HomRNA.html",
...
output$reportPCA <- downloadHandler(
  ...
  # For html output, change this to "report.html"
  filename = "report_PCA_HomRNA.html",
  content = function(file) {
...
output$reportDEA <- downloadHandler(
  ...
  # For html output, change this to "report.html"
  filename = "report_DEA_HomRNA.html",
  content = function(file) {
...
output$reportEA <- downloadHandler(
  ...
  # For html output, change this to "report.html"
  filename = "report_EA_HomRNA.html",
  content = function(file) {
